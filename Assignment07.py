...
class Person:
    ...
    ChangeLog:
        - Tom Lowder, 11.25.2024: Created the class.
    """
# TODO Add first_name and last_name properties to the constructor (Done)
def __init__(self, first_name: str = "", last_name: str = ""): # (Use this decorator for the setter or mutator)
...
def first_name(self, value: str):
    if value.isalpha() or value == "": # allow alphabetic characters or the default empty string
...
class Student(Person): # Add a class name to indicate explicit inheritance.
    """
       ...
       Tom Lowder,11.25.2024,Created Class
       """
